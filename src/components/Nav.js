            ...
            <div className={`nav ${navScroll && "nav__scroll"} ${window.location.pathname !== '/' && "nav__bg__color"}`} id="nav">
                ...
                <div className={`nav__container `}>
                    ...
                    <Link to="subhead" smooth={true} offset={-150} duration={1000}>
                        <h2 className={`${navScroll && "scroll__color"}`}>Khalid ibrahim</h2>
                    </Link>
                    ...
                    <nav className={`nav__links ${openMenu && "display__nav"} `}>
                        ...
                        <div className="links">
                            <ul className={`${navScroll && "scroll__color"}`}>
                                <Link onClick={()=> setOpenMenu(false)} to="subhead" smooth={true} duration={1000} offset={-150}><div className="ul__div " > <Home className="ul__icon" /> <li>home </li> </div> </Link>
                                <Link onClick={()=> setOpenMenu(false)} to="about" smooth={true} duration={1000} offset={-150}><div className="ul__div " > <Person className="ul__icon" /><li>about</li> </div> </Link>
                                <Link onClick={()=> setOpenMenu(false)} to="projects" smooth={true} duration={1000} offset={-120}><div className="ul__div " > <LibraryBooks className="ul__icon" /><li>Projects </li> </div> </Link>
                            </ul>
                        </div>
